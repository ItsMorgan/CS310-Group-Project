...
public class Parse_Digit_4 extends Pattern_Parser {
    ...
    Pattern p400 = Pattern.compile("^400[!\"&'()*+,\\-./0-9:;<=>?A-Z_a-z]{1,30}[%\\x1D]");    
    Pattern p400eol = Pattern.compile("^400[!\"&'()*+,\\-./0-9:;<=>?A-Z_a-z]{1,30}$");        
    Pattern p401 = Pattern.compile("^401[!\"&'()*+,\\-./0-9:;<=>?A-Z_a-z]{1,30}[%\\x1D]");    
    Pattern p401eol = Pattern.compile("^401[!\"&'()*+,\\-./0-9:;<=>?A-Z_a-z]{1,30}$");        
    Pattern p402 = Pattern.compile("^402[0-9]{17}[%\\x1D]");    
    Pattern p402eol = Pattern.compile("^402[0-9]{17}$");        
    Pattern p403 = Pattern.compile("^403[!\"&'()*+,\\-./0-9:;<=>?A-Z_a-z]{1,30}[%\\x1D]");    
    Pattern p403eol = Pattern.compile("^403[!\"&'()*+,\\-./0-9:;<=>?A-Z_a-z]{1,30}$");        
    ...
    Pattern p420 = Pattern.compile("^420[!\"&'()*+,\\-./0-9:;<=>?A-Z_a-z]{1,20}[%\\x1D]");    
    Pattern p420eol = Pattern.compile("^420[!\"&'()*+,\\-./0-9:;<=>?A-Z_a-z]{1,20}$");        
    Pattern p421 = Pattern.compile("^421[0-9]{3}[!\"&'()*+,\\-./0-9:;<=>?A-Z_a-z]{1,9}[%\\x1D]"); 
    Pattern p421eol = Pattern.compile("^421[0,9]{3}[!\"&'()*+,\\-./0-9:;<=>?A-Z_a-z]{1,9}$");
    ...
    Pattern p427 = Pattern.compile("^427[!\"&'()*+,\\-./0-9:;<=>?A-Z_a-z]{1,3}[%\\x1D]");
    Pattern p427eol = Pattern.compile("^427[!\"&'()*+,\\-./0-9:;<=>?A-Z_a-z]{1,3}$");
