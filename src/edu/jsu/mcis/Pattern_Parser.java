...
public class Pattern_Parser {
    ...
    public ArrayList<Matcher> parse(String input) {
        ...
        Pattern p390n = Pattern.compile("^390n[0,9]{1,15}[%\\x1D]");      // AI #390n
        Pattern p390neol = Pattern.compile("^390n[0,9]{1,15}$");          // AI #390neol
        Pattern p391n = Pattern.compile("^390n[0-9]{3}[0,9]{1,15}[%\\x1D]");      // AI #390n
        Pattern p391neol = Pattern.compile("^390n[0-9]{3}[0,9]{1,15}}$");          // AI #390neol
        Pattern p392n = Pattern.compile("^392n[0,9]{1,15}[%\\x1D]");      // AI #392n
        Pattern p392neol = Pattern.compile("^392[0,9]{1,15}$");          // AI #392neol
        Pattern p393n = Pattern.compile("^393n[0-9]{3}[0,9]{1,15}[%\\x1D]");      // AI #393n
        Pattern p393neol = Pattern.compile("^393n[0-9]{3}[0,9]{1,15}}$");          // AI #393neol
